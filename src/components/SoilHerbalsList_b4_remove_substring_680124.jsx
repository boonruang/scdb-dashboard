        ...
        <Divider sx={{ mb: 1 }}/>
          <Box display="flex" flexDirection="column" justifyContent="center" sx={{ ml: 1, maxWidth: 140 }} >
            ...
            <Box>
              ...
              {result?.commonname && result?.commonname.substring(0, 15)}
              </Typography>                   
            </Box>
            <Box>
              <Typography variant="body2" color={colors.greenAccent[600]} display='inline'>
              ...
              <Typography ml="5px" variant="body2" display='inline'>
              {result?.scientificname && result?.scientificname.substring(0, 10)}
              </Typography>                   
            </Box>    
            <Box>
              <Typography variant="body2" color={colors.greenAccent[600]} display='inline'>
              ...
              <Typography ml="5px" variant="body2" display='inline'>
              {result?.othername && result?.othername.substring(0, 15)}
              </Typography>                   
            </Box>                      
          </Box>    
          {/* <Divider sx={{ mt: 1.5 }}/> */}
