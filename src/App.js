...
import BudgetPlanDetail from "scenes/budgetplan/BudgetPlanDetail";
...
import BudgetActivityDetail from "scenes/budgetactivity/BudgetActivityDetail";
...
import BudgetDisbursementDetail from "scenes/budgetdisbursement/BudgetDisbursementDetail";
  ...
  <Routes>
      ...
      <Route path="/" element={<Layout />}>
        ...
        <Route element={<SecureRoute allowedRoles={[ROLES.Admin,ROLES.Editor,ROLES.User]} /> }>
          ...
          <Route path="budgetplan/detail" element={<BudgetPlanDetail />} />
          ...
          <Route path="budgetactivity/detail" element={<BudgetActivityDetail />} />
          ...
          <Route path="budgetdisbursement/detail" element={<BudgetDisbursementDetail />} />
