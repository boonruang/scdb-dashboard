...
import { addAcademicGrant } from '../../actions/academicGrant.action'
...
var AcademicGrantAdd = function() {
  ...
  var initialValues = {
    student_code: '', firstname: '', lastname: '', major_name: '',
    grant_name: '', conference_name: '', amount: '', grant_type: '', grant_source: '',
  }
  ...
  return (
    <Box m="20px">
      <Header title="เพิ่มข้อมูลทุนนำเสนอ" />
      <Formik
...
export default AcademicGrantAdd
