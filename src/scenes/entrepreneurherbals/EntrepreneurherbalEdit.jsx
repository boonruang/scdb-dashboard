...
import { updateEntrepreneurherbals } from '../../actions/entrepreneurherbal.action'
...
useEffect(() => {
  ...
  //  }
   ...
   const handleCancelButton = () => {
    ...
    return <Box m="20px">
        <Header title="ปรับปรุงข้อมูลผู้ประกอบการ" subtitle="ปรับปรุงข้อมูลผู้ประกอบการผลิตภัณฑ์สมุนไพร" />
        ...
        <Formik
            ...
            onSubmit={async (values, { setSubmitting }) => {
              ...
              dispatch(updateEntrepreneurherbals(navigate, formData))
              setSubmitting(false)
            }}
...
export default EntrepreneurherbalEdit