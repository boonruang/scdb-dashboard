...
const EntrepreneurherbalDetail = () => {
  ...
  // const { result } = useSelector((state) => state.app.roleReducer)
      ...
      return <Box m="20px">
        <Header title="รายละเอียดข้อมูลผู้ประกอบการ" subtitle="รายละเอียดผู้ประกอบการผลิตภัณฑ์สมุนไพร" />
                <Box>
                    {/* tab1 */}
                        <Typography>
                            ข้อมูลเบื้องต้น
                    ...
                    <TextField
                        ...
                        value={location?.state?.row?.entretype?.name}
                        name="service_type"
                        sx={{ gridColumn: "span 1" }}
                        InputLabelProps={{ shrink: true }}
                        disabled
                   ...
                   <TextField
                    ...
                    <TextField
                     ...
                     <TextField
                         ...
                         type="text"
                         label="แบรนด์สินค้า"
                         value={location.state.row.brand}
                         name="brand"     
                         sx={{ gridColumn: "span 1" }}
                         InputLabelProps={{ shrink: true }}
                         disabled
                     ...
                     <TextField
                         ...
                         value={location.state.row.standard}
                         name="standard"     
                         sx={{ gridColumn: "span 1" }}
                         InputLabelProps={{ shrink: true }}
                         disabled
...
export default EntrepreneurherbalDetail