...
import { addCollaborativefarm } from '../../actions/collaborativefarm.action'
...
//  },[herbalReducer.result])
 ...
 const handleSubmitButton = () => {
    ...
    return <Box m="20px" >
        <Header title="เพิ่มข้อมูลกลุ่มเกษตรกรแปลงใหญ่" />
        <Formik
            ...
            onSubmit={async (values, { setSubmitting }) => {
              ...
              dispatch(addCollaborativefarm(navigate, formData))
              setSubmitting(false)
            }}
                        ...
                        sx={{
                            ...
                            {/* <Field
                             ...
                             <Autocomplete
                                ...
                                onChange={(e, value) => {
                                    setFieldValue(`farmers[${index}].farmerId`, value ? value.id : '');
                                }}
                                value={
                                    farmerResult?.find(farm => farm.id === values.farmers[index]?.farmerId) || null
                                }
                                renderInput={(params) => (
                                    <TextField
                                    {...params}
...
export default CollaborativefarmAdd