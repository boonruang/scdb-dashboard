...
import { updateCollaborativefarm } from '../../actions/collaborativefarm.action'
...
const CollaborativefarmEdit = () => {
  ...
  const [collaborativefarmId, setCollaborativefarmId] = useState(null)
...
const handleConfirmBox = () => {
    // dispatch(deleteHerbal(herbalId))
    ...
    return <Box m="20px" >
        <Header title="ปรับปรุงข้อมูลกลุ่มเกษตรกรแปลงใหญ่" />
        <Formik
            ...
            onSubmit={async (values, { setSubmitting }) => {
              ...
              formData.append('propertyname', values.cert)
              ...
              dispatch(updateCollaborativefarm(navigate, formData))
              setSubmitting(false)
            }}
        ...
        >
            {({ values, errors, touched, dirty, isSubmitting, isValid, handleBlur, handleChange, handleSubmit, setFieldValue, addDeleteChange }) => (
                      ...
                      {values.herbals.map((_, index) => (                   
                        ...
                        sx={{
                            ...
                            {/* <Field
                                ...
                                name={`herbals[${index}].collaborativefarmherbals.herbalId`} 
                                defaultValue=""
                                component={txtField}
                            ...
                            <Field name={`herbals[${index}].collaborativefarmherbals.herbalId`}>
                            {({ field, meta, form }) => (
                            <Autocomplete
                                fullWidth
                                ...
                                form.setFieldValue(`herbals[${index}].collaborativefarmherbals.herbalId`, newValue ? newValue.id : "");
                                }}
                                renderInput={(params) => (
                                <TextField
                                    {...params}
                            ...
                            <Field
                                ...
                                name={`herbals[${index}].collaborativefarmherbals.area`} 
                                sx={{ gridColumn: "span 2" }}
                                /> 
                            ...
                            <Field
                                ...
                                name={`herbals[${index}].collaborativefarmherbals.output`} 
                                sx={{ gridColumn: "span 2" }}
                            />  
                            <TextField
                                fullWidth
                                ...
                                // value={values.herbals[index].collaborativefarmherbals.area * values.herbals[index].collaborativefarmherbals.output}
                                value={
                                    (parseFloat(values.herbals[index]?.collaborativefarmherbals?.area || 0) *
                                    parseFloat(values.herbals[index]?.collaborativefarmherbals?.output || 0)).toFixed(2)
                                }                                
                                InputProps={{
                                readOnly: true,
                                }}
                      ...
                      {values.farmers.map((_, index) => (                   
                        ...
                        sx={{
                            ...
                            {/* <Field
                                ...
                                select
                                name={`farmers[${index}].collaborativefarmfarmers.farmerId`} 
                                defaultValue=""
                                component={txtField}
                                sx={{ gridColumn: "span 2" }} >
                          ...
                          <Field name={`farmers[${index}].collaborativefarmfarmers.farmerId`}>
                            {({ field, meta, form }) => (
                            <Autocomplete
                                fullWidth
                                options={farmerResult || []}
                                getOptionLabel={(option) => option ? `${option.id} ${option.firstname} ${option.lastname}` : ''}
                                isOptionEqualToValue={(option, value) => option.id === value}
                                value={farmerResult?.find((opt) => opt.id === field.value) || null}
                                onChange={(event, newValue) => {
                                form.setFieldValue(`farmers[${index}].collaborativefarmfarmers.farmerId`, newValue ? newValue.id : "");
                                }}
                                renderInput={(params) => (
                                <TextField
                                    {...params}
        ...
        submitFunction={() => handleConfirmBox()}
...
export default CollaborativefarmEdit