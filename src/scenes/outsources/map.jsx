...
const Outsourcemap = (props) => {
  ...
  const dispatch = useDispatch();
    ...
    const { result } = useSelector((state) => state.app.outsourcemapReducer)
            ...
            <Header title="ข้อมูลแผนที่" subtitle="แหล่งแปรรูป" />
              ...
              <Box height={ isSidebar ? "86vh" : "90vh" } width="100%" borderRadius="4px" sx={{overflow: "hidden"}} > 
                  <AutoSizer>
                   ...
                   {/* LIST HERE    */}
                      <OutsourceList searchTerm={debouncedSearchValue} />
                </Box>
          </Box>
      );
    }
