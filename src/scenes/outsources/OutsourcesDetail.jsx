...
const OutsourcesDetail = () => {
  ...
  // const { result } = useSelector((state) => state.app.roleReducer)
      ...
      return <Box m="20px">
        <Header title="แหล่งแปรรูป" subtitle="รายละเอียดโครงสร้างพื้นฐานการแปรรูป"  />
                <Box>
                    {/* tab1 */}
                        <Typography>
                            ข้อมูลเบื้องต้น
                   ...
                   <TextField
                    ...
                    <TextField
                     ...
                     <TextField
                         ...
                         value={location.state.row.services}
                         name="services"     
                         sx={{ gridColumn: "span 1" }}
                         InputLabelProps={{ shrink: true }}
                     /> 
...
export default OutsourcesDetail