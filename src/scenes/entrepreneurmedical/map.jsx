...
import EntremedList from '../../components/EntremedList'
...
const Entrepreneurmedicalmap = (props) => {
  ...
  const dispatch = useDispatch();
    ...
    const { result } = useSelector((state) => state.app.entrepreneumedicalmapReducer)
    ...
    useEffect(() => {
      ...
      return (
        <Box m="20px">
            <Header title="ด้านการแพทย์แผนไทย(map)" />
              ...
              <Box height={ isSidebar ? "86vh" : "90vh" } width="100%" borderRadius="4px" sx={{overflow: "hidden"}} > 
                  <AutoSizer>
                   ...
                   {/* LIST HERE    */}
                      <EntremedList searchTerm={debouncedSearchValue} />
                </Box>
          </Box>
      );
    }

export default Entrepreneurmedicalmap;