...
import { updateEntrepreneurmedicals } from '../../actions/entrepreneurmedical.action'
...
const EntrepreneurmedicalEdit = () => {
  ...
  //  }
   ...
   const handleCancelButton = () => {
    ...
    return <Box m="20px">
        <Header title="ปรับปรุงข้อมูลผู้ประกอบการ" subtitle="ปรับปรุงข้อมูลผู้ประกอบการด้านการแพทย์แผนไทย/สมุนไพร" />
        ...
        <Formik
            ...
            onSubmit={async (values, { setSubmitting }) => {
              ...
              dispatch(updateEntrepreneurmedicals(navigate, formData))
              setSubmitting(false)
            }}
...
export default EntrepreneurmedicalEdit