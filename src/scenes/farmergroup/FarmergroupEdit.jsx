...
import { updateFarmergroup } from '../../actions/farmergroup.action'
...
const handleConfirmBox = () => {
    ...
    return <Box m="20px" >
        <Header title="ปรับปรุงข้อมูลกลุ่มเกษตรกร" />
        <Formik
            ...
            onSubmit={async (values, { setSubmitting }) => {
              ...
              dispatch(updateFarmergroup(navigate, formData))
              setSubmitting(false)
            }}
                      ...
                      {values.herbals.map((_, index) => (                   
                        ...
                        sx={{
                            ...
                            {/* <Field
                                ...
                                name={`herbals[${index}].farmergroupherbals.herbalId`} 
                                defaultValue=""
                                component={txtField}
                            ...
                            <Field name={`herbals[${index}].farmergroupherbals.herbalId`}>
                            {({ field, meta, form }) => (
                            <Autocomplete
                                fullWidth
                                ...
                                form.setFieldValue(`herbals[${index}].farmergroupherbals.herbalId`, newValue ? newValue.id : "");
                                }}
                                renderInput={(params) => (
                                <TextField
                                    {...params}
                            ...
                            <Field
                                ...
                                name={`herbals[${index}].farmergroupherbals.area`} 
                                sx={{ gridColumn: "span 2" }}
                                /> 
                            ...
                            <Field
                                ...
                                type="text"
                                component={txtField}
                                label="ปริมาณผลผลิต (กก./ไรฝปี)"
                                name={`herbals[${index}].farmergroupherbals.output`} 
                                sx={{ gridColumn: "span 2" }}
                            />  
                            {/* <PredictedOutputFieldEdit index={index} /> */}
                            <TextField
                                fullWidth
                                variant="filled"
                                label="คาดการณ์ผลผลิต (กก./ปี)"
                                // value={values.herbals[index].farmergroupherbals.area * values.herbals[index].farmergroupherbals.output}
                                value={
                                    (parseFloat(values.herbals[index]?.farmergroupherbals?.area || 0) *
                                    parseFloat(values.herbals[index]?.farmergroupherbals?.output || 0)).toFixed(2)
                                }                                
                                InputProps={{
                                readOnly: true,
                                }}
                      ...
                      {values.farmers.map((_, index) => (                   
                        ...
                        sx={{
                            ...
                            {/* <Field
                                ...
                                select
                                name={`farmers[${index}].farmergroupfarmers.farmerId`} 
                                defaultValue=""
                                component={txtField}
                                sx={{ gridColumn: "span 2" }} >
                          ...
                          <Field name={`farmers[${index}].farmergroupfarmers.farmerId`}>
                            {({ field, meta, form }) => (
                            <Autocomplete
                                fullWidth
                                ...
                                onChange={(event, newValue) => {
                                form.setFieldValue(`farmers[${index}].farmergroupfarmers.farmerId`, newValue ? newValue.id : "");
                                }}
                                renderInput={(params) => (
                                <TextField
                                    {...params}
...
export default FarmergroupEdit