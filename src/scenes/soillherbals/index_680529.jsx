...
import { setStateHerbalSelectedToFetching } from 'actions/herbalselectedmap.action'
...
const SoilHerbals = (props) => {
  ...
  const [searchValue, setSearchValue] = useState('มะระ')
  ...
  const dispatch = useDispatch();
    ...
    const { selectedResult  } = useSelector((state) => state.app.herbalselectedmapReducer)
