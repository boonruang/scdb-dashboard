...
const HerbalAdd = () => {
  ...
  //     return <img src={photo} style={{ width: '320px', height: '180px', objectFit: 'cover', padding: '0.75rem' }} />
  //   })
  // }
        ...
        <Formik
            ...
            onSubmit={async (values, { setSubmitting }) => {
              ...
              for (let i=0; i <  selectedImages.length; i++) {
                ...
                // console.log('selectedImages',  selectedImages[i].file.name)
              }
              // for (let i=0; i <  values.file.length; i++) {
              //   formData.append('image',  values.file[i])
              //   console.log(' values.file',  values.file[i])
              // }
              // console.log('see values.file',values.file[0])
              // console.log('see selectedImages',selectedImages[0])

              // for (let i=0; i <  values.file.length; i++) {
              //   // console.log(' values.file',  values.file[i].name)
              //   for (let j=0; j <  selectedImages.length; j++) {
              //     // console.log(' selectedImages',  selectedImages[j].file.name)
              //     if (values.file[i].name == selectedImages[j].file.name) {
              //       formData.append('image',  values.file[i])
              //       console.log(`values.file[${i}]`,  values.file[i].name)
              //       console.log(`selectedImages[${j}]`,  selectedImages[j].file.name)
              //     }
              //   }
              // }
