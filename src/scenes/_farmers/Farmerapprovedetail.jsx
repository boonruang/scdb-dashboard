...
import { setFarmersRegisterApproveById, setFarmersRegisterNotApproveById} from '../../actions/register.action'
...
const FarmerApproveDetail = () => {
  ...
  const handleApprovalClick = () => {
        ...
        navigate('/farmers/pending')
  }

  const handleNotApprovalClick = () => {
        // console.log('Not Approved Id', location.state.row.id)
        dispatch(setFarmersRegisterNotApproveById(location.state.row.id))
        navigate('/farmers/pending')        
  }
                ...
                <Box mt='40px'>
                  ...
                  <Box
                    ...
                    >
                        ...
                        <Button  
                            onClick={() => (handleNotApprovalClick())}
                            sx={{
                                backgroundColor: colors.greenAccent[600],
                                color: colors.grey[100],
                                fontSize: "14px",
...
export default FarmerApproveDetail