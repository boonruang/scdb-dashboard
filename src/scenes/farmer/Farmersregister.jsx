...
import { getFarmersHistoryRegister } from '../../actions/farmer.action'
...
const Farmersregister = () => {
    ...
    useEffect(() => {
        dispatch(getFarmersHistoryRegister())
    },[dispatch])
    ...
    return (
        <Box m="20px">
            <Header title="ข้อมูลประวัติการลงทะเบียนของเกษตรกร" subtitle="การลงทะเบียนของเกษตรกร 3 เดือนล่าสุด" />
