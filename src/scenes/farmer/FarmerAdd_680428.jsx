                    ...
                    <Box mt="10px"
                      ...
                      {values.herbals.map((_, index) => (                   
                        ...
                        sx={{
                            ...
                            {/* Autocomplete แทน Field select */}
                            <Autocomplete
                                options={herbalSearchResult}
                                getOptionLabel={(option) => option.herbalname || ''}
                      ...
                      {values.farmergroups.map((_, index) => (                   
                        ...
                        sx={{
                            ...
                            <Field
                                ...
                                label="กลุ่มเกษตรกร"
                                select
                                name={`farmergroups[${index}].farmergroupId`} 
                                defaultValue=""
                                component={txtField}
                                sx={{ gridColumn: "span 2" }} >
                      ...
                      {values.collaborativefarms.map((_, index) => (                   
                        ...
                        sx={{
                            ...
                            <Field
                                ...
                                label="กลุ่มเกษตรกร"
                                select
                                name={`collaborativefarms[${index}].collaborativefarmId`} 
                                defaultValue=""
                                component={txtField}
                                sx={{ gridColumn: "span 2" }} >
