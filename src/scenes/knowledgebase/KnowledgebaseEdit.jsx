...
import { updateKnowledgebase } from '../../actions/knowledgebase.action'
...
const KnowledgebaseEdit = () => {
  ...
  //  }
   ...
   const handleCancelButton = () => {
    ...
    return <Box m="20px">
        <Header title="ปรับปรุงข้อมูล" subtitle="ปรับปรุงข้อมูลองค์ความรู้การแพทย์แผนไทย" />
        ...
        <Formik
            ...
            onSubmit={async (values, { setSubmitting }) => {
              ...
              dispatch(updateKnowledgebase(navigate, formData))
              setSubmitting(false)
            }}
