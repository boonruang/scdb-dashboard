...
const PhilosopherDetail = () => {
  ...
  // const { result } = useSelector((state) => state.app.roleReducer)
      ...
      return <Box m="20px">
        <Header title="รายละเอียดข้อมูล" subtitle="ปราชญ์สมุนไพร" />
                <Box>
                    {/* tab1 */}
                        <Typography>
                            ข้อมูลเบื้องต้น
                   ...
                   <TextField
                    ...
                    <TextField
                     ...
                     <TextField
                         ...
                         value={location.state.row.knowledge}
                         name="knowledge"     
                         sx={{ gridColumn: "span 1" }}
                         InputLabelProps={{ shrink: true }}
                     /> 
                     <TextField
                         ...
                         value={location.state.row.course}
                         name="course"     
                         sx={{ gridColumn: "span 1" }}
                         InputLabelProps={{ shrink: true }}
                     /> 
                ...
                <Box 
                    ...
                    >
                      ...
                      >
                          <Box mr="20px">                
                            <Item image={location.state.row.photo}/>
                          </Box>                        
                          <Box>
