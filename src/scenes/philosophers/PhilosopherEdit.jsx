...
import { updatePhilosopher } from '../../actions/philosopher.action'
...
const PhilosopherEdit = () => {
  ...
  const [center, setCenter] = useState(INITIAL_CENTER);    
   ...
   const handleCancelButton = () => {
    ...
    return <Box m="20px">
        <Header title="ปรับปรุงข้อมูล" subtitle="ปราชญ์สมุนไพร" />
        ...
        <Formik
            ...
            onSubmit={async (values, { setSubmitting }) => {
              ...
              dispatch(updatePhilosopher(navigate, formData))
              setSubmitting(false)
            }}
...
export default PhilosopherEdit