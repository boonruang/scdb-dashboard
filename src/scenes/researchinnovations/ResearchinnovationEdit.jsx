...
import { updateResearchinnovation } from '../../actions/researchinnovations.action'
...
const ResearchinnovationEdit = () => {
  ...
  //  }
   ...
   const handleCancelButton = () => {
    ...
    return <Box m="20px">
        <Header title="ปรับปรุงข้อมูล" subtitle="ปรับปรุงข้อมูลงานวิจัยและนวัตกรรม" />
        ...
        <Formik
            ...
            onSubmit={async (values, { setSubmitting }) => {
              ...
              dispatch(updateResearchinnovation(navigate, formData))
              setSubmitting(false)
            }}
...
export default ResearchinnovationEdit