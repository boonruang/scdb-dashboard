...
import herbalmkplc_config from '../../data/herbalmkplc_config.json';
...
import HerbalMarketplaceList from '../../components/HerbalMarketplaceList'
...
// import { getHerbalmarketplaces } from '../../actions/herbalmarketplacemap.action'
...
const Herbalmarketplacemap = (props) => {
  ...
  const dispatch = useDispatch();
    ...
    const { result } = useSelector((state) => state.app.herbalmarketplacemapReducer)
            ...
            <Header title="ข้อมูลแผนที่" subtitle="แหล่งขาย" />
              ...
              <Box height={ isSidebar ? "86vh" : "90vh" } width="100%" borderRadius="4px" sx={{overflow: "hidden"}} > 
                  <AutoSizer>
                   ...
                   {/* LIST HERE    */}
                      <HerbalMarketplaceList searchTerm={debouncedSearchValue} />
                </Box>
          </Box>
      );
    }
...
export default Herbalmarketplacemap;