...
import { updateManufacturer } from '../../actions/manufacturer.action'
...
//    }
   ...
   const handleCancelButton = () => {
    ...
    return <Box m="20px">
        <Header title="ปรับปรุงข้อมูล" subtitle="ปรับปรุงข้อมูลโรงงานผู้ผลิตผลิตภัณฑ์สมุนไพร" />
        <Formik
            ...
            onSubmit={async (values, { setSubmitting }) => {
              ...
              dispatch(updateManufacturer(navigate, formData))
              setSubmitting(false)
            }}
