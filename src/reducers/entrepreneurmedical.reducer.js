...
const entrepreneurmedicalReducer = (state = initialState, { type, payload }) => {
  switch (type) {
    case HTTP_ENTREPRENEURMEDICAL_FETCHING:
      return { ...state, result: null, isFetching: true, isError: false };
    case HTTP_ENTREPRENEURMEDICAL_SUCCESS:
      return { ...state, result: payload.result, isFetching: false, isError: false };
    case HTTP_ENTREPRENEURMEDICAL_FAILED:
...
export default entrepreneurmedicalReducer
