...
const entrepreneumedicalmapReducer = (state = initialState, { type, payload }) => {
  switch (type) {
    case HTTP_ENTREPRENEURMEDICAL_MAP_FETCHING:
      return { ...state, result: null, isFetching: true, isError: false };
    case HTTP_ENTREPRENEURMEDICAL_MAP_SUCCESS:
      return { ...state, result: payload.result, isFetching: false, isError: false };
    case HTTP_ENTREPRENEURMEDICAL_MAP_FAILED:
      return { ...state, result: null, isFetching: false, isError: true };
    case HTTP_ENTREPRENEURMEDICAL_SELECTED_SUCCESS:
      return { ...state, selectedResult: payload.result, isSelectedError: false, isSelectedFetching : false };            
    case HTTP_ENTREPRENEURMEDICAL_SELECTED_FAILED:
      return { ...state, selectedResult: null, isSelectedError: true, isSelectedFetching : false };            
    case HTTP_ENTREPRENEURMEDICAL_SELECTED_FETCHING:
...
export default entrepreneumedicalmapReducer
